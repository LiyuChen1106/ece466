...
public class generator_rT implements Runnable{
private int N;
private int L;
private int r;
...
public generator_rT(InetAddress add, int N,int L,int r, int rp, int sp){
this.add=add;
this.N=N;
this.L=L;
this.r=r;
...
System.arraycopy(toByteArray(1),2,buf,2,2);
