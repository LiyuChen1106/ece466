...
[packet_no_p, time_p, packetsize_p] = textread('generator_near.txt', '%f %f %f');
figure(1);
i=1;
time1(i)=0;
...
[packet_no_p3, time_p3, packetsize_p3] = textread('sink_near.txt', '%f %f %f');
i=1;
time3(i)=0;
...
title('Cumulative arrival function of the generator, token bucket and sink for case3');
xlabel('time (in microseconds)');
ylabel('Cumulative arrivals (in bytes)');
%xlim([0,2.1e6]);
%legend 
