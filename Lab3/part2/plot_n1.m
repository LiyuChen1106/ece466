...
%Poisson
[packet_no_p, time_p, packetsize_p] = textread('generator_pos_n1.txt', '%f %f %f');
i=1;
time1p(i)=0;
...
[packet_no_p3, time_p3, packetsize_p3] = textread('sink_pos_n1.txt', '%f %f %f');
...
%Video
[packet_no_p, time_p, packetsize_p] = textread('generator_vedio_n1.txt', '%f %f %f');
i=1;
time1(i)=0;
...
[packet_no_p3, time_p3, packetsize_p3] = textread('sink_video_n1.txt', '%f %f %f');
