...
[time_p2, packetsize_p2, bufferSize1, bufferSize2, bufferType] = textread('ps_n5.txt', '%f %f %f %f %f');
...
%Poisson
[packet_no_p, time_p, packetsize_p] = textread('generator_pos_n5.txt', '%f %f %f');
i=1;
time1p(i)=0;
...
[packet_no_p3, time_p3, packetsize_p3] = textread('sink_pos_n5.txt', '%f %f %f');
...
%Video
[packet_no_p, time_p, packetsize_p] = textread('generator_vedio_n5.txt', '%f %f %f');
i=1;
time1(i)=0;
...
[packet_no_p3, time_p3, packetsize_p3] = textread('sink_video_n5.txt', '%f %f %f');
...
set(fig2,'OuterPosition',[1 1 900 600]);
saveas(fig2,'plot_n5_waitingtime','png');
