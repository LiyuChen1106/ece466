...
[time_p2, packetsize_p2, bufferSize, noToken] = textread('bucket_pos_3_2.txt', '%f %f %f %f');
i=1;
time2(i)=0;
...
title('Content of token bucket and buffer backlog for Poisson');
...
saveas(1,'plot_pos_tbbacklog_3_2','png');