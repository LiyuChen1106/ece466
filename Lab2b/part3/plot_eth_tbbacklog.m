...
[time_p2, packetsize_p2, bufferSize, noToken] = textread('bucket_eth.txt', '%f %f %f %f');
i=1;
time2(i)=0;
...
title('Content of token bucket and buffer backlog for Ethernet');
...
saveas(1,'plot_eth_tbbacklog','png');